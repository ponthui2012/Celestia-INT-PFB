{
    ...
    form.addEventListener('submit', async (e) => {
      ...
      .then(response => {
        ...
        document.getElementById("result_namespace_id").innerHTML = data.namespace_id;
        document.getElementById("result_height").innerHTML = data.height;
        document.getElementById("result_gas_wanted").innerHTML = data.gas_wanted;
        document.getElementById("result_gas_used").innerHTML = data.gas_used;
        document.getElementById("result_decode_data").innerHTML = data.data;
        document.getElementById("result_encode_data").innerHTML = data.data_hex;
        document.getElementById("result_tx_hash").innerHTML = data.txhash;
        document.getElementById("result_code").innerHTML = data.code;
        document.getElementById("result_tx_hash_link").setAttribute("href", api.explorer + "txs/" + data.txhash);
